   ...
   Vendors = {
      ...
      },
      {
         ...
         Recipes = {
            ...
            { ID = 5577, Type = RRS("Blacksmithing"), Skill = 100, Cost = 1200 },
            { ID = 7977, Type = RRS("Blacksmithing"), Skill = 220, Cost = 8000 },
            { ID = 12816, Type = RRS("Blacksmithing"), Skill = 260, Cost = 12000 },
            { ID = 12826, Type = RRS("Blacksmithing"), Skill = 285, Cost = 20000 },
         },
      },
      {
      ...
      {
         Name = RRS("Gordon Hardfoot"),
         Team = "Alliance",
         Coordinates = {
            { x = 0.650, y = 0.479 },
         },
         Recipes = {
            { ID = 61786, Type = RRS("Blacksmithing"), Skill = 25, Cost = 300 },
            { ID = 61787, Type = RRS("Blacksmithing"), Skill = 90, Cost = 500 },
            { ID = 61788, Type = RRS("Blacksmithing"), Skill = 140, Cost = 1200 },
            { ID = 61789, Type = RRS("Blacksmithing"), Skill = 190, Cost = 2000 },
         },
      },
      {
         Name = RRS("Otto Fencer"),
         Team = "Alliance",
         Coordinates = {
            { x = 0.494, y = 0.742 },
         },
...
[RRS("Ironforge")] = {
   ...
   Vendors = {
      ...
      {
         Name = RRS("Thurgrum Deepforge"),
         Team = "Alliance",
         Coordinates = {
            { x = 0.517, y = 0.428 },
         },
         Recipes = {
            { ID = 6734, Type = RRS("Blacksmithing"), Skill = 70, Cost = 250 },
            { ID = 6736, Type = RRS("Blacksmithing"), Skill = 140, Cost = 1800 },
         },
      },
      {
         Name = RRS("Dagred Flintbeard"),
         Team = "Alliance",
         Coordinates = {
            { x = 0.585, y = 0.241 },
         },
   ...
   Vendors = {
      ...
      },
      {
         ...
         Recipes = {
            ...
            { ID = 16041, Type = RRS("Engineering"), Skill = 260, Cost = 12000 },
            { ID = 16042, Type = RRS("Engineering"), Skill = 260, Cost = 12000 },
            { ID = 83511, Type = RRS("Engineering"), Skill = 125, Cost = 1000 },
         },
      },
      {
         Name = RRS("Sumi"),
...
[RRS("Durotar")] = {
   ...
   Vendors = {
      ...
      },
      {
         ...
         Recipes = {
            { ID = 12832, Type = RRS("Blacksmithing"), Skill = 300, Cost = 40000 },
         },
      },
      {
         Name = RRS("Nantai Truthwind"),
         Team = "Horde",
         Coordinates = {
            { x = 0.448, y = 0.144 },
         },
...
[RRS("Thunder Bluff")] = {
   ...
   Vendors = {
      ...
      {
         Name = RRS("Taur Stonehoof"),
         Team = "Horde",
         Coordinates = {
            { x = 0.379, y = 0.282 },
         },
         Recipes = {
            { ID = 12831, Type = RRS("Blacksmithing"), Skill = 300, Cost = 40000 },
         },
      },
   },
},
   ...
   Vendors = {
      ...
      },
      {
         ...
         Recipes = {
            ...
            { ID = 12818, Type = RRS("Blacksmithing"), Skill = 270, Cost = 12500 },
            { ID = 61790, Type = RRS("Blacksmithing"), Skill = 240, Cost = 5000 },
         },
      },
      {
         Name = RRS("Vizzklick"),
   ...
   Vendors = {
      {
         ...
         Recipes = {
            ...
            { ID = 55057, Type = RRS("Blacksmithing"), Skill = 300, Cost = 100000 },
         },
      },
   },
},
   ...
   Vendors = {
      {
         ...
         Recipes = {
            { ID = 7976, Type = RRS("Blacksmithing"), Skill = 215, Cost = 8000 },
         },
      },
      {
         Name = RRS("Tanner Fralsh"),
         Team = "Alliance",
         Coordinates = {
            { x = 0.641, y = 0.721 },
         },
...
[RRS("Blackstone Island")] = {
   IsCity = false,
   Continent = 1,
   MapFile = "Blackstone-Island",
   MapScale = 0.06752073749910,
   MapOffset = { x = 0.63425868944744, y = 0.48916979012457 },
   Vendors = {
      {
         Name = RRS("Gox Borelight"),
         Team = "Alliance",
         Coordinates = {
            { x = 0.583, y = 0.244 },
         },
...
[RRS("Thalassian Highlands")] = {
   IsCity = false,
   Continent = 2,
   MapFile = "Thalassian-Highlands",
   MapScale = 0.08769200982010,
   MapOffset = { x = 0.48309795798539, y =  0.10715655813760},
   Vendors = {
      {
         Name = RRS("Calaire Solarguard"),
         Team = "Alliance",
         Coordinates = {
            { x = 0.47, y = 0.669 },
         },
...
[RRS("Gillijim's Isle")] = {
   ...
   Continent = 2,
   MapFile = "Gillijim",
   MapScale = 0.08753739103054,
   MapOffset = { x = 0.32851740081163, y = 0.85207528893761 },
   Vendors = {
      {
         Name = RRS("Isidora"),
         Team = "Neutral",
...
[RRS("Tel'Abim")] = {
   ...
   Continent = 1,
   MapFile = "Tel-Abim",
   MapScale = 0.08841758717467,
   MapOffset = { x = 0.60450310147763, y = 0.81456557772855 },
   Vendors = {
      {
         Name = RRS("Wazlon Headiron"),
         Team = "Neutral",
         Coordinates = {
            { x = 0.429, y = 0.795 },
         },
